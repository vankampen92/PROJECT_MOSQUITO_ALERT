			       ...
			       Parameter_Model * P )
{
  ...
  for(i=0; i<no; i++){
    ...
    PATCH[i]->No_of_AGES = P->No_of_AGES;
...
void Print_Meta_Community_Patch_System (Parameter_Table * Table)
{
  ...
  Sp = Table->No_of_AGES; /* 'The number of state variables that fully define 
